// "BeyondVR Hack" — final output-stage per-eye scale. 16-bit variant:
// identical math, `rgba16unorm` storage so the 10-bit export pipeline
// keeps full precision through this stage.
//
